...
| | Status | Approved; construction not yet started |
| | Start year | Info not available |
| | Business model | IDM (Integrated Device Manufacturer) |
| **Capability** | Chip type | Analog / Others (Power) |
| | Detailed chip type | SiC power devices — MOSFETs; applications include EV inverters, defence, railways, fast-charging |
