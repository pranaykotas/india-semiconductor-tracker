...
| **Owner** | Tata Electronics Private Limited |
| **Owner headquarters** | India |
| **Ultimate owner** | Tata Group |
| **Status** | Under construction |
| **Start year** | 2026 (expected) |
| **Business model** | Foundry |
| **Chip type** | IC-Logic |
| **Detailed chip type** | Info not available (foundry; depends on customer orders) |
...
| **Process technologies** | DUV lithography; High-K dielectrics |
| **Semiconductor material** | Silicon (Si) |
| **Wafer capacity** | ~50,000 wafer starts per month (target) |
